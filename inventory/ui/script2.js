...
const handleUse = e => {
    ...
    /*inventoryNotification('use', elem.id);*/
...
function inventoryNotification(type, item){
	if (type == 'use') {
		console.log(type);
		console.log(item);
		document.getElementById('invNotification').style.display = 'block';
		/*document.getElementById('inventoryNotification-class-text').text = 'XxUżyto';
		document.getElementById('inventoryNotification-itemname').text = item;*/

		setTimeout(function() {
			document.getElementById('invNotification').style.display = 'none';
		}, 3000);
	}
}